...
\affil{Mobile Cloud Computing Research Group\\TU Berlin \& Einstein Center Digital Future\\Berlin, Germany\\\texttt{\{tp,mg\}@mcc.tu-berlin.de}}
% \date{}
...
Instead, go and read the \emph{AllgStuPO} and \emph{StuPO} now if you have not yet.
Even if you have, it can not hurt to do so again as a refresher.
...
To find a research question, you must start with a research area you are interested in.
...
To find an advisor, consider the research groups where you have done some specialization and, e.g., have successfully completed a module.
...
When you write them, it is important to make clear what your research interests are and ideally, optionally already think about an interesting topic. 
...
An expos\'e should typically only cover one A4 page and can be written in three to five paragraphs.
...
The expectation is that you already have an understanding of the research area and made some initial research.
...
Here, try to be as detailed as possible to avoid confusion during the work on your thesis.
...
What is stated in the Expose is not a fixed list of requirements and tasks. 
If you realize during your thesis that, e.g., the evaluation method proposed in the expose is not suitable after all, then you can and must choose another suitable method. 
...
We will cover both things together since the approach is identical -- the best way to write your thesis is start at the beginning and finish at the end.
...
It is also common to add a list of contributions, similarly to what we have done in Section~\ref{sec:introduction}.

\subsection{Background}

The next part of your research (and thesis manuscript) is the dreaded background.
At this point, you should have done some initial research using \cite{gscholar}, read some papers, looked at some existing work in the field.
...
However, be smart with your time and do not spend too much on one obscure paper -- the citation count is usually a good indicator on how a paper has aged (more on selecting the right resources in Section~\ref{sec:faq}).
...
Do not feel pressured to have something novel or surprising here, it is often best to stick with what you and your advisor came up with together.
...
When you write a systems paper, e.g., your idea is to write a new kind of database, do not include your implementation of this system here.
For example, for the design of your database system, it does not matter whether it was written in Java or C++.
...
You will want to evaluate your approach in your thesis (and we will get to that), but your evaluation should be in a different section.
...
You can simply write yourself a small simulation environment (it is often not necessary to use any existing framework) and plug in a dataset or algorithm.
...
There will be edge cases, limitations and or scenarios where other approaches are better.
...
The goal of this is not to discredit these papers but rather to show how your research builds on them, where you have used them for inspiration, and how different approaches may even be combined to create an even more effective solution.
Keep it nice!
...
If you can not find anything that answers your research question specifically, broaden your search area.
...
Some research papers also use this to provide an outlook on future work you plan to do -- in most cases, students do not continue to work on their thesis projects, though.
...
We can not teach you how to conduct your research here (this is a skill you should have honed in your studies), but we want to give you some tips and guidelines.
...
To clearly show what your idea can and can not do, give a holistic overview of state-of-the-art research, including competing ideas.
...
We recommend~\cite{ltex},~\cite{textidote} for LaTeX and VS Code, but you may choose a different one based on your preferences.
...
We can not cover everything in this article, so we do want to draw your attention to a few further resources.
