...
Even if you have, it cannot hurt to do so again as a refresher.
...
What is stated in the expos\'e is not a fixed list of requirements and tasks.
...
However, be smart with your time and do not spend too much on one obscure paper -- the citation count is usually a good indicator on how well a paper has aged (more on selecting the right resources in Section~\ref{sec:research}).
...
You can also include a formal proof for your approach if that is the best way to show its correctness.
...
We cannot teach you how to conduct your research here (this is a skill you should have honed in your studies), but we want to give you some tips and guidelines.
...
Depending on the platform, we recommend ~\cite{ltex} and~\cite{textidote}, but you may choose a different one based on your preferences.
...
\paragraph{Don't plagiarize}
\emph{Tl;dr:} Don't do it.
Don't present someone else's work or ideas as your own.
If you quote a source verbatim, use quotation marks.
If you paraphrase, acknowledge the authors of the original work.
Quoting other work shows that you have taken the time to read and understand related work, which increases the trustworthiness of your own work.
Do it!
...
This shows that you understand the text and are not mindlessly copy-pasting.
